...
from app import db
from app.models import Course, Enrollment, Lesson, LessonProgress, Quiz, Submission
...
def complete_lesson(course_id, lesson_id):
    ...
    if enrollment:
        ...
        enrollment.progress = min(100, (completed_items / total_items) * 100) if total_items > 0 else 0
